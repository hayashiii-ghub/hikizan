...
問いへの答えと、理解に必要な根拠・背景を返す。コードや資料への参照を添え、影響範囲と未確認事項が分かる形にする。

## 判断の観点

- 観測した事実、そこから導ける影響、検証が必要な仮説を分ける。説明がつくことと、原因が確かめられたことを同一視しない
- ファイルの一覧だけで終えず、責務やデータの流れなど、問いの答えを理解するために必要な関係を示す。固有の用語は、その意味と役割を短く説明する
- 調査の深さは、残る不確実性が結論を変えるかで決める。情報量を増やすためだけに範囲を広げない
