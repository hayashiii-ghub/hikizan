...
推奨案と、それが目的に合う理由、選ぶことで変わる成果・負担を返す。計画を求められた場合は、実現する変更と確認方法が分かる形にする。

## 判断の観点

- 新しい構想や見直しでは、目的と必須制約から必要性を考える。既存案を残すことも、作り直すことも前提にしない
- 比較は、利用者が得るもの、維持する負担、取り消しやすさで行う。現状維持が有効なら候補に含め、結論を変えない細かな案を並べない
- 将来の拡張は、今回の要求や根拠のある制約に必要な分だけ含める。判断を左右する前提が未確認なら、その前提と確かめ方を示す
