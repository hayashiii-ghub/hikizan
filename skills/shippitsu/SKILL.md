...
日本語の文章を書く / 推敲するskill。標準規範は`references/writing-style.md`に従う。記事、書籍の章、読み物として順に読ませる長い解説、平坦さや緩急を直す文章では`references/cognitive-rhythm.md`を追加で使う。コードや実行仕様Markdownのレビューは`sadoku`、PR本文は`teishutsu`へ渡す。
...
- next: [teishutsu / sadoku / Markdownで完了]
